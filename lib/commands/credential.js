...
const revoke = program
  ...
  .action(async (holder, hash) => {
    ...
    try {
      ...
      const params = new ContractFunctionParameters()
          .addAddress(holderAddress)
          .addBytes32(ethers.utils.arrayify(hash));

      const result = await executeFunction('revokeCredential', params);
...
const suspend = program
  ...
  .action(async (holder, hash) => {
    ...
    try {
      ...
      const result = await executeFunction('suspendCredential', params);
...
const unsuspend = program
  ...
  .action(async (holder, hash) => {
    ...
    try {
      ...
      const result = await executeFunction('unsuspendCredential', params);
...
const update = program
  ...
  .action(async (holder, hash, options) => {
    ...
    try {
      ...
      const result = await executeFunction('updateCredential', params);
...
const get = program
  ...
  .action(async (holder, hash) => {
    ...
    try {
      ...
      const credInfo = await queryFunction('getCredential', params);
...
const verify = program
  ...
  .action(async (holder, hash) => {
    ...
    try {
      ...
      const isValid = await queryFunction('verifyCredential', params);
